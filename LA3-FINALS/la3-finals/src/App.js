...
function sidebar() {
  return (
    <div
      className="w-60 hidden lg:block sticky top-0 h-screen bg-opacity-0 from-custom-color-playlist-card-non-pinned-text to-custom-color text-white">
      {/* <!-- LOGO --> */}
      <a href="/#">
      ...
      <nav className="flex flex-row justify-center flex-wrap font-normal text-lg pt-7">
        <ul className="flex-grow">
          <li>
            <a href="/dist/home.html"
              className="flex justify-center text-white space-x-5 mt-6 mb-3 py-1 px-10 rounded-full ml-10 mr-10  bg-custom-color-sidebar-brown  hover:bg-custom-color-navbar-icons-hover focus:bg-black focus:outline-none active:bg-custom-color-sidebar-brown hover:text-white">
          ...
          <li>
            <a href="/dist/search-page.html"
              className="flex text-white justify-center space-x-5 mt-6 mb-3 py-1 px-10 hover:text-custom-color-sidebar-brown-hover">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                stroke="currentColor" className="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <li>
            <a href="/dist/queue.html"
              className="flex justify-center text-white space-x-5 mt-6 mb-3 py-1 px-10 hover:text-custom-color-sidebar-brown-hover">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                stroke="currentColor" className="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        {/* <!-- DIVIDER --> */}
        <div className="mx-auto w-3/4 border-t-1 bg-gray-400 border-gray-400 mt-5 mb-6"></div>
        <div className="absolute ml-3 top-4 left-56 h-[85%] border-l bg-gray-400 w-[1px] border-gray-400"></div>

        <ul className="text-white">
          <li><a href="/dist/addplaylist.html"
              className="flex justify-center text-white space-x-4 pl-5 mt-6 mb-3 rounded-full py-1 hover:text-custom-color-sidebar-brown-hover">
          ...
          <li>
            <a href="/dist/likedsongs.html"
              className="flex justify-center text-white space-x-5 mt-6 mb-3 py-1 hover:text-custom-color-sidebar-brown-hover">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                <path
...
function topNavBar() {
  return (
    // TOP NAVBAR
    <div className="mb-5 justify-start sticky top-0 flex flex-row items-center py-1 md:mb-0 bg-custom-color bg-opacity-95 md:justify-end md:pr-16 md:pb-3 md:pt-3 z-50">
      {/* <!-- LOGO --> */}
...
function mainContent() {
  return (
    <div className="pl-9 xl:pr-16 pr-9 bg-opacity-0">
        {/* <!--Page Header--> */}
        <div>
          <div>
            <h1 className="mt-3 text-4xl">Good Evening!</h1>
          </div>
        </div>
...
function topPicks(){
  return(
    // TOP PICKS 
    <div>
              <h1 className="text-[28px] mt-2">Top Picks</h1>
        {/* <!--Top Picks Container--> */}
...
function recentlyPlayed() {
  return(
    // RECENTLY PLAYED
    <div>
              <div className="text-[28px] mt-[12px] mb-[25px] flex justify-between items-center">
...
function whatYouLiked(){
  return(
    <div>
              <div className="text-[28px] mt-[12px] mb-[24px] flex justify-between items-center">
    ...
    <div className="flex flex-col md:flex-row flex-wrap font-normal text-sm sm:text-base mt-auto h-auto pb-36 z-40">
      <div className="w-fit h-fit mx-5 my-2">
        <ul className="text-custom-color-footer-text px-3 space-y-2">
          <li className="text-white py-3">Company</li>
      ...
      <div className="w-fit h-fit mx-5 my-2">
        <ul className="text-custom-color-footer-text px-3 space-y-2">
            <li className="text-white py-3">Communities</li>
      ...
      <div className="w-fit h-fit mx-5 my-2">
        <ul className="text-custom-color-footer-text px-3 space-y-2">
            <li className="text-white py-3">Support</li>
      ...
      <div className="flex flex-grow flex-wrap justify-start md:justify-end pr-6 pl-5">
        <button className="w-10 h-10 my-3 mx-3 bg-custom-color-footer-social-icons rounded-full flex items-center justify-center">
            <div className="w-7 h-7">
                <svg className="text-white fill-current hover:text-custom-color-navbar-icons-hover" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
